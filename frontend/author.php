            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full lg:w-2/3 px-4">
                    ...
                    <div class="post-container">
                        ...
                        ?>
                            <h2 class="page-heading text-2xl sm:text-3xl font-bold mb-6">News By <?php echo $row1['username']; ?></h2>
                            <?php
                        ...
                        <?php
                            ...
                            if (mysqli_num_rows($result1) > 0) {
                                ...
                                if ($page > 1) {
                                    echo '<li><a href="author.php?aid=' . $auth_id . '&page=' . ($page - 1) . '" class="px-3 py-1 bg-gray-300 text-gray-700 rounded hover:bg-gray-400">Prev</a></li>';
                                }
                                for ($i = 1; $i <= $total_page; $i++) {
                                    $active = ($i == $page) ? "bg-blue-500 text-white" : "bg-gray-300 text-gray-700 hover:bg-gray-400";
                                    echo '<li><a href="author.php?aid=' . $auth_id . '&page=' . $i . '" class="px-3 py-1 ' . $active . ' rounded">' . $i . '</a></li>';
                                }
                                if ($total_page > $page) {
                                    echo '<li><a href="author.php?aid=' . $auth_id . '&page=' . ($page + 1) . '" class="px-3 py-1 bg-gray-300 text-gray-700 rounded hover:bg-gray-400">Next</a></li>';
                                }
